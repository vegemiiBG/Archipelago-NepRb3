...
LocationData("Otori Forest","Gather 1", 35_1, "Gather"),
LocationData("Otori Forest","Gather 2", 35_2, "Gather"),
LocationData("Otori Forest","Gather 3", 35_3, "Gather"),
LocationData("Otori Forest","Gather 4", 35_4, "Gather"),
LocationData("Otori Forest","Gather 5", 35_5, "Gather"),
LocationData("Otori Forest","Gather 6", 35_6, "Gather"),
LocationData("Otori Forest","Gather 7", 35_7, "Gather"),
LocationData("Otori Forest","Gather 8", 35_8, "Gather"),
)
