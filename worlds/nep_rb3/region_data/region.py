...
all_dungeon_regions:List[RegionData] = [
    ...
    RegionData(wanderers_cave,                      400,    1,  10,    wanderers_cave_depths           ,changeDungeon=plan_dungeonchangewandererscave,bigChangeDungeon=plan_bigdungeonchangewandererscave),
    ...
    RegionData(kuzarat_facility_1,                  400,    1,  10,    kuzarat_facility_2              ,changeDungeon=plan_dungeonchangekuzaratfacility,bigChangeDungeon=plan_bigdungeonchangekuzaratfacility),
    ...
    RegionData(metroid_shelter_depths,              600,    2,  40,    metroid_shelter                 ,changeDungeon=plan_dungeonchangemetroidshelter,bigChangeDungeon=plan_bigdungeonchangemetroidshelter),
