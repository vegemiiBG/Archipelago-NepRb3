...
def set_all_hyper_dungeons(world: "NepRb3World") -> None:
    ...
    world.set_rule(hyper_planeptune_alley, lambda state: checkDungeonRequirements(5305, state, world.player)        and hasDungeonUnlocked(state,world.player,DungeonNames.planeptune_alley) and hasLevel(90, state, world.player))
