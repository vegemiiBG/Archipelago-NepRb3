...
def set_all_planeptune_dungeons(world: "NepRb3World") -> None:
    ...
    world.set_rule(planeptune_haneda_mountain_peak, lambda state:  state.can_reach_region(DungeonNames.haneda_mountain_range,world.player) and checkDungeonRequirements(1050, state, world.player))
    ...
    world.set_rule(planeptune_powerlevel_island_interior, lambda state:  state.can_reach_region(DungeonNames.powerlevel_island,world.player) and checkDungeonRequirements(3050, state, world.player))
    ...
    world.set_rule(planeptune_digital_future_depths,lambda state:  state.can_reach_region(DungeonNames.digital_future_land,world.player) and checkDungeonRequirements(8050,state,world.player))
...
def set_all_lastation_dungeons(world: "NepRb3World") -> None:
    ...
    world.set_rule(lastation_anonydeath_depths, lambda state:  state.can_reach_region(DungeonNames.anonydeaths_lab,world.player)  and checkDungeonRequirements(650, state, world.player))
    ...
    world.set_rule(lastation_wanderers_depths, lambda state:  state.can_reach_region(DungeonNames.wanderers_cave,world.player)  and checkDungeonRequirements(250, state, world.player))
    ...
    world.set_rule(lastation_kuzarat_inner, lambda state:  state.can_reach_region(DungeonNames.kuzarat_facility_1,world.player) and checkDungeonRequirements(250, state, world.player))
...
def set_all_lowee_dungeons(world: "NepRb3World") -> None:
    ...
    world.set_rule(lowee_metroid_shelter_depths, lambda state:  state.can_reach_region(DungeonNames.metroid_shelter,world.player) and checkDungeonRequirements(600, state, world.player))
    ...
    world.set_rule(lowee_underground_cave, lambda state:  state.can_reach_region(DungeonNames.castle_chambers,world.player) and checkDungeonRequirements(350, state, world.player))
...
def set_all_leanbox_dungeons(world: "NepRb3World") -> None:
    ...
    world.set_rule(leanbox_emes_magma_depths, lambda state:  state.can_reach_region(DungeonNames.em_es_magma_cave,world.player) and checkDungeonRequirements(1500, state, world.player))
...
def set_all_hello_dungeons(world: "NepRb3World") -> None:
    ...
    world.set_rule(hello_suaho_mountain_peak, lambda state: state.can_reach_region(DungeonNames.suaho_mountain_range,world.player) and checkDungeonRequirements(1200, state, world.player))
...
def set_all_eden_dungeons(world: "NepRb3World") -> None:
    ...
    world.set_rule(eden_magma_cave, lambda state: checkDungeonRequirements(2750, state, world.player)        and hasDungeonUnlocked(state,world.player,DungeonNames.magma_cave))
    world.set_rule(eden_magma_cave_depths, lambda state: state.can_reach_region(DungeonNames.magma_cave,world.player) and checkDungeonRequirements(2750, state, world.player))
    world.set_rule(eden_extradimensional_space, lambda state: checkDungeonRequirements(2750, state, world.player)        and hasDungeonUnlocked(state,world.player,DungeonNames.extradimensional_space))
    world.set_rule(eden_graphic_pass, lambda state: checkDungeonRequirements(2750, state, world.player)        and hasDungeonUnlocked(state,world.player,DungeonNames.graphic_pass))
    world.set_rule(eden_graphic_peak, lambda state: state.can_reach_region(DungeonNames.graphic_pass,world.player) and checkDungeonRequirements(2750, state, world.player))
    world.set_rule(eden_duorruins, lambda state: checkDungeonRequirements(2750, state, world.player)        and hasDungeonUnlocked(state,world.player,DungeonNames.duo_r_ruins))
    world.set_rule(eden_koagura_plateau, lambda state: checkDungeonRequirements(2750, state, world.player)        and hasDungeonUnlocked(state,world.player,DungeonNames.koagura_plateau))
...
def set_all_hyper_dungeons(world: "NepRb3World") -> None:
    ...
    world.set_rule(hyper_virtua_depths, lambda state: state.can_reach_region(DungeonNames.virtua_forest,world.player) and checkDungeonRequirements(1200, state, world.player))
    ...
    world.set_rule(hyper_under_depths, lambda state: state.can_reach_region(DungeonNames.under_inverse,world.player) and checkDungeonRequirements(4500, state, world.player))
