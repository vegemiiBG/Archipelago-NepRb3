...
LocationData("Virtua Forest Safe Zone","Gather 1", 1_1, "Gather"),
LocationData("Virtua Forest Safe Zone","Gather 2", 1_2, "Gather"),
LocationData("Virtua Forest Safe Zone","Gather 3", 1_3, "Gather"),
LocationData("Virtua Forest Safe Zone","Gather 4", 1_4, "Gather"),
LocationData("Virtua Forest Safe Zone","Gather 5", 1_5, "Gather"),
LocationData("Virtua Forest Safe Zone","Gather 6", 1_6, "Gather"),
LocationData("Virtua Forest Safe Zone","Gather 7", 1_7, "Gather"),
)
