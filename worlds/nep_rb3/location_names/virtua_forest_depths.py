...
LocationData("Virtua Forest Depths","Gather 1", 55_1, "Gather"),
LocationData("Virtua Forest Depths","Gather 2", 55_2, "Gather"),
LocationData("Virtua Forest Depths","Gather 3", 55_3, "Gather"),
LocationData("Virtua Forest Depths","Gather 4", 55_4, "Gather"),
LocationData("Virtua Forest Depths","Gather 5", 55_5, "Gather"),
)
