...
LocationData("Gigo Depths","Gather 1", 18_1, "Gather"),
LocationData("Gigo Depths","Gather 2", 18_2, "Gather"),
LocationData("Gigo Depths","Gather 3", 18_3, "Gather"),
LocationData("Gigo Depths","Gather 4", 18_4, "Gather"),
LocationData("Gigo Depths","Gather 5", 18_5, "Gather"),
)
