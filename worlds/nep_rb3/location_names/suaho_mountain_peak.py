...
LocationData("Suaho Mountain Peak","Gather 1", 60_1, "Gather"),
LocationData("Suaho Mountain Peak","Gather 2", 60_2, "Gather"),
LocationData("Suaho Mountain Peak","Gather 3", 60_3, "Gather"),
LocationData("Suaho Mountain Peak","Gather 4", 60_4, "Gather"),
LocationData("Suaho Mountain Peak","Gather 5", 60_5, "Gather"),
)
