...
LocationData("Ario Plateau","Gather 1", 27_1, "Gather"),
LocationData("Ario Plateau","Gather 2", 27_2, "Gather"),
LocationData("Ario Plateau","Gather 3", 27_3, "Gather"),
LocationData("Ario Plateau","Gather 4", 27_4, "Gather"),
)
